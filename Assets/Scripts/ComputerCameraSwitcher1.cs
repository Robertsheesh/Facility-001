...
public class ComputerInteraction1 : MonoBehaviour
{
    ...
    private ComputerCLI1 computerCLI;                 // Reference to the ComputerCLI script
    ...
    void Start()
    {
        ...
        {
            computerCLI = computerCLIObject.GetComponent<ComputerCLI1>();
        }
