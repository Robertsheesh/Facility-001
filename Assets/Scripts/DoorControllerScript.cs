...
public class DoorController1 : MonoBehaviour
{
    ...
    public Light buttonLight2;         // Second button light (e.g., other side of the door)
    ...
    {
        if (buttonLight1 != null) buttonLight1.color = color;
        if (buttonLight2 != null) buttonLight2.color = color;
    }
}
